...
//         const imageUrl = imageFile ? `https://sfqoiwmaxoxpaibcploq.supabase.co/storage/v1/object/public/upcoming_events/${folderName}/${imageFile.name}` : '';
    ...
    try {
      ...
      const eventPromises = data.map(async (folder) => {
        ...
        const imageUrl = imageFile
          ? `https://sfqoiwmaxoxpaibcploq.supabase.co/storage/v1/object/public/upcoming_events/${folderName}/${imageFile.name}`
          : '';
