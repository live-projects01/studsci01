...
function Signup() {
  return (
    ...
    <div className='min-h-screen w-full mt-14'>
        ...
        <div className='h-auto flex flex-col justify-center items-center gap-5 mx-64 rounded-xl shadow-md bg-white'>
            
            <h1 className='text-5xl font-bold text-blue-800 mb-10 py-4 px-4'>Register</h1>
            <input className='p-3 m-2 rounded-lg shadow-sm outline w-1/4' placeholder='First Name'/>
            <input className='p-3 m-2 rounded-lg shadow-sm outline w-1/4' placeholder='Last Name'/>
            <input className='p-3 m-2 rounded-lg shadow-sm outline w-1/4' placeholder='Email Address'/>
            <button className='p-5 m-2 rounded-xl shadow-sm hover:outline mb-20 bg-blue-200 hover:bg-blue-800 px-10 hover:text-white text-blue-800'>Sign Up</button>
        </div>
        </div>
